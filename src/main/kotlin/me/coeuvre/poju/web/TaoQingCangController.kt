...
class TaoQingCangController(@Autowired val service: TaoQingCangService) {
    ...
    fun exportActivityItems(@RequestBody request: ExportActivityItemsRequest): Mono<ResponseEntity<ByteArray>> = service.exportActivityItems(request).map { workbook ->
